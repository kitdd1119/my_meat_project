package com.example.meat_project.common.config.security;
...
import com.example.meat_project.common.config.security.auth.CustomAuthenticationFailureHandler;
import com.example.meat_project.common.config.security.auth.CustomAuthenticationSuccessHandler;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity.authorizeHttpRequests(
        config -> config
            ...
            // .hasAuthority("ROLE_ADMIN") // hasRole 말고 hasAuthority를 쓰는 이유는 hasRole은
            // ROLE_이 붙어야만 인식하기 때문이다.
